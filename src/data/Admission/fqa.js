export const fqa = [
  {
    id: 1,
    question:
      'Does the School have facilities to address Special Education Needs?',
    answer:
  ...
  {
    id: 2,
    question: 'Whom should a parent approach for any extraordinary leave?',
    answer:
  ...
  },
  {
    id: 3,
    question:
      'What documentation is needed for the admission of an adopted student?',
    answer:
  ...
  {
    id: 5,
    question: 'When are the next dates for Aptitude Assessment for admission?',
    answer:
