...
export const navData = [
    ...
    },
    {
      ...
      dropdown: [
        ...
        { id: 15, title: 'Principles & Policies', path: '/Principles & Policies' },
    ...
    },
    {
      ...
      dropdown: [
        ...
        { id: 43, title: 'Swimming Pool Form', path: '/studentlife/swimmingpool' },
        { id: 44, title: 'Blood Donation Form', path: '/studentlife/blood-donation' },
        ...
        { id: 53, title: 'Transfer Certificate', path: '/studentlife/transfer-cert' },
      ],
    },
    {
      id: 5,
    ...
    },
    {
      ...
      dropdown: [
        ...
        { id: 73, title: 'CBSE-OASIS', path: '/mandatory-disclosures/CBSE-OASIS' },
        { id: 74, title: 'Mandatory Public Disclosures', path: '/mandatory-disclosures/public-discolusers' },
      ],
    },
    {
      id: 7,
