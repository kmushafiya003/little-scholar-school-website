...
const FlipCard = ({text1, text2, className, handlar,  frontImage, backImage, useBgImage }) => {
  return (
    <div className={` w-full relative ${className}`} onClick={handlar}>
      <div
        className='md:p-5 box-container md:w-full sm:w-full dxs:-inset-1 '
      >
              ...
              <div className='inner color-white'
               style={
                useBgImage && frontImage
                  ? { backgroundImage: `url(${frontImage})`, backgroundSize: 'cover' }
                  : {}
              }>
