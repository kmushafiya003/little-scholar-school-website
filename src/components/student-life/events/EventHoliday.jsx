...
const EventHoliday = ({ eventMonth }) => {
  ...
  const selectedMonth = selectedEvent.months.find(month => month.month === eventMonth);

  return (
    <section className='relative w-full'>
      <div className='w-10/12 pt-20 pb-10 mx-auto'>
        {selectedMonth && selectedMonth.specialDayDetails.map((data, index) => (
          <div key={index} className='p-4 mb-4 bg-white rounded-lg shadow-2xl'>
