          ...
          <div className="flex flex-col    gap-4">
            ...
            <div className="w-[90%] md:w-full m-4 md:m-0">
              ...
              <input
                ...
                className={`w-full p-4  bg-gray-100 text-black focus:outline-none focus:border-4 border-blue-600 ${
            ...
            <div className="w-[90%] md:w-full m-4 md:m-0">
              ...
              <input
                ...
                className={`w-full p-4  bg-gray-100 text-black focus:outline-none focus:border-4 border-blue-600 ${
                  errors.experience ? 'border-red-500' : 'border-blue-900'
                }`}
              />
            ...
            <div className="w-[90%] md:w-full m-4 md:m-0">
              ...
              <input
                ...
                className={`w-full p-4  bg-gray-100 text-black focus:outline-none focus:border-4 border-blue-600 ${
                  errors.busStop ? 'border-red-500' : 'border-blue-900'
                }`}
              />
            ...
            <div className="w-[90%] md:w-full m-4 md:m-0">
              ...
              <select
                ...
                className={`w-full p-4  bg-gray-100 text-black focus:outline-none focus:border-4 border-blue-600 ${
                  errors.committee1 ? 'border-red-500' : 'border-blue-900'
                }`}
              >
                <option value="">Select</option>
           ...
           <div className="w-[90%] md:w-full m-4 md:m-0">
              ...
              <select
                ...
                className={`w-full p-4  bg-gray-100 text-black focus:outline-none focus:border-4 border-blue-600 ${
                  errors.committee2 ? 'border-red-500' : 'border-blue-900'
                }`}
              >
                <option value="">Select</option>
                <option value="UNODC">UNODC</option>
            ...
            <div className="w-[90%] md:w-full m-4 md:m-0">
              ...
              <select
                ...
                className={`w-full p-4 bg-gray-100 text-black focus:outline-none focus:border-4 border-blue-600 ${
                  errors.committee3 ? 'border-red-500' : 'border-blue-900'
                }`}
              >
                <option value="">Select</option>
                <option value="UNODC">UNODC</option>
            ...
            <div className="w-[90%] md:w-full m-4 md:m-0">
              ...
              <input
                ...
                className={`w-full p-4 bg-gray-100 text-black focus:outline-none focus:border-4 border-blue-600 ${
                  errors.file ? 'border-red-500' : 'border-blue-900'
                }`}
              />
