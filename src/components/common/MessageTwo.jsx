    ...
    <section className='relative w-full text-white bg-transparent'>
      <div className='w-10/12 mx-auto'>
        {message2.map((data, index) => (
          <div
            key={index}
            className='flex flex-col items-center justify-center p-5 my-10 border md:flex-row md:items-start rounded-xl'
          >
            <div className='flex flex-col mb-5 text-center md:text-left md:mr-5 md:mb-0'>
              <div
                className='h-56 bg-center bg-cover w-80 md:w-64 md:h-48 lg:w-72 lg:h-56 '
