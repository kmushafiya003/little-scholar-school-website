...
const HeroSection = () => {
  return (
    <section id="home" className="w-full xl:h-[700px] xlg:h-[650px] lg:h-[600px] xmd:h-[560px] smd:h-[510px] md:h-[480px] sm:h-[520px] xs:h-[480px] h-[420px]">
                ...
                >
                  {index === 0 && (
                    <>
                      ...
                      <p className="mb-6 text-sm sm:text-base md:text-lg">At Little Scholars, we inspire, we learn, we grow.</p>
                      <Link
                        to="/OnlineRegistration"
                        className="px-3 py-1 text-sm font-semibold text-white sm:text-base bg-red w-max hover:bg-bright-black md:text-lg md:py-2 md:px-12"
                      >
                        Get Enroll
                      </Link>
                    </>
                  ...
                  {index === 1 && (
                    <>
                      ...
                      <div className="px-4 py-2 mx-auto mt-4 text-lg font-semibold text-center text-white uppercase border-0 rounded-full w-max sm:text-2xl md:text-2xl border-r-6 border-l-6 border-red md:px-6 md:py-3">
                        Bright Futures Begin Here
                      </div>
                      <p className="mx-auto mb-4 text-sm text-center sm:text-base w-max md:text-xl">Little Scholars: Where Bright Futures Begin.</p>
                      <Link
                        to="/OnlineRegistration"
                        className="px-4 py-2 mx-auto text-sm font-semibold text-white sm:text-base bg-red hover:bg-bright-black md:text-xl md:py-3 md:px-12"
                      >
                        Get Enroll
                      </Link>
                    </>
                  ...
                  {index === 2 && (
                    <>
                      ...
                      <div className="px-4 py-2 mt-4 ml-auto text-lg font-semibold text-center text-white uppercase border-0 rounded-full w-max sm:text-2xl md:text-2xl border-l-6 border-red md:px-6 md:py-3">
                        Unlock Potential.
                      </div>
                      <p className="mb-4 ml-auto text-sm text-right sm:text-base md:text-xl">Little Scholars: Unlocking Every Child's Potential.</p>
                      <Link
                        to="/OnlineRegistration"
                        className="px-4 py-2 ml-auto text-sm font-semibold text-white sm:text-base w-max bg-red hover:bg-bright-black md:text-lg md:py-3 sm:px-12"
                      >
                        Get Enroll
                      </Link>
                    </>
