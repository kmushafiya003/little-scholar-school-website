      ...
      <div className='grid grid-cols-2 xmd:flex xmd:justify-center   '>
        {
          IconData.map((data)=>{
            return(
              <div key={data.id} className='xl:w-[80%] xmd:w-[90%] px-4 border border-border-grey transition-all duration-500 ease-in-out py-4  flex flex-col gap-y-2 items-center justify-center  hover:scale-105 group'>
