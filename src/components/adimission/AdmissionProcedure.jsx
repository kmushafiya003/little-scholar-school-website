...
const admissionProcedure = {
    ...
    steps: [
        "Procure prospectus/admission form from the school office on any working day between 9:30 am and 1:00 pm OR Use the Online Admission form available on our official website. www.littlescholars-kashipur.com",
    ...
    return (
        <section className="relative w-full">
            <div className='w-10/12 mx-auto'>
                <h2 className="mb-4 text-[2.2rem] font-semibold mt-20">{admissionProcedure.title}</h2>
                {/* ----------- small underline ----------- */}
